...
export default function TechnicianWelcomeScreen() {
      ...
      {visible && (
        ...
        >
          ...
          <motion.div
            ...
            className="absolute w-[500px] h-[500px] bg-cyan-500/20 blur-[120px] rounded-full"
          />
          ...
          {/* Loader */}
          <motion.div
            className="mt-10 w-14 h-14 rounded-full border-4 border-white/20 border-t-cyan-400"
            animate={{ rotate: 360 }}
