...
useEffect(() => {
        ...
        <div
          ...
          <div
            ...
            <div
              ...
              {msg.readAt && isMine && (
                <span className="text-[10px] text-green-200 whitespace-nowrap">
                  ✓✓
                </span>
              )}
            </div>
  ...
  ${menuOpen || showActions ? "opacity-100" : "opacity-0 md:group-hover:opacity-70"}
`}>
          ...
          {menuOpen && isMine && (
            <div
              ref={ref}
              className={`absolute right-0 z-30 bg-background border border-border rounded-xl shadow-lg overflow-hidden min-w-[130px]
