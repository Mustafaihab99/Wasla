    ...
    <div className="min-h-screen w-full bg-gradient-to-b from-background via-background/90 to-background/80 pb-20 px-4 space-y-12">
      ...
      <div className="w-full max-w-6xl mx-auto grid md:grid-cols-2 gap-6">
        <motion.div
          ...
          className="p-6 bg-gradient-to-br from-blue-500/20 to-purple-500/20 border border-white/20 rounded-2xl shadow-lg cursor-pointer flex items-center justify-between"
        ...
        <motion.div
          whileHover={{ scale: 1.05 }}
          className="p-6 bg-gradient-to-br from-pink-500/20 to-red-500/20 border border-white/20 rounded-2xl shadow-lg cursor-pointer flex items-center justify-between"
        ...
        <motion.div
          whileHover={{ scale: 1.05 }}
          className="p-6 bg-gradient-to-br from-purple-500/15 to-indigo-500/20 border border-white/20 rounded-2xl shadow-lg cursor-pointer flex items-center justify-between"
          onClick={() => navigate("/community-loader")}>
          <span className="font-semibold text-lg text-purple-500">
            {t("common.Community")}
          </span>
          <RiUserCommunityLine className="text-pink-800 text-3xl" />
        </motion.div>
      </div>
