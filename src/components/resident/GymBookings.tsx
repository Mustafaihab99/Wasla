      ...
      <div className="grid md:grid-cols-2 gap-6 max-w-6xl mx-auto">
        {bookings.map((g: GymResidentBookingData) => {
          const hasActions =
            ...
            (g.isPaid &&
              g.qrCode &&
              (g.bookingStatus === 0 || g.bookingStatus === 1));
          return (
            <motion.div
              key={g.bookingId}
                    ...
                    <div className="flex flex-col gap-2 md:items-end">
                      {(g.bookingStatus === 0 || g.bookingStatus === 3) && (
                        <button
                          ...
                          disabled={isPending}
                          className="w-full sm:w-auto px-4 py-2 rounded-lg bg-red-600 text-white font-semibold hover:bg-red-700 disabled:opacity-50 transition">
                      ...
                      {g.isPaid &&
                        ...
                        (g.bookingStatus === 0 || g.bookingStatus === 1) && (
                          <button
                            ...
                            className="w-full sm:w-auto flex items-center justify-center gap-2 px-3 py-2 text-sm rounded-lg border border-primary text-primary hover:bg-primary hover:text-white transition">
                            <FaQrcode size={14} />
                            {t("gym.showQR")}
                          </button>
                        )}
