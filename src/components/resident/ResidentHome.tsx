    ...
    <div className="pt-24 px-4 lg:px-20">
      ...
      <section className="mb-20">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6">
          {[
              { title: t("resident.doctor"), icon: <FaStethoscope /> },
              { title: t("resident.rest"), icon: <IoRestaurant /> },
              { title: t("resident.technical"), icon: <FaTools /> },
              { title: t("resident.gym"), icon: <MdFitnessCenter /> },
              { title: t("resident.driver"), icon: <FaTaxi /> },
          ].map((s, i) => (
            <motion.div
              key={i}
