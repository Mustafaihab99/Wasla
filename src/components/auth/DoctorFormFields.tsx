...
export default function DoctorFormFields({ email }: { email: string }) {
  ...
  <div className="flex flex-col">
    ...
    <label className="font-medium mb-1 text-foreground">{t("profile.doctor.name")}</label>
    <Field
      name="FullName"
  ...
  {/* Specialization */}
  <div className="flex flex-col">
    <label className="font-medium mb-1 text-foreground">{t("profile.doctor.Specialization")}</label>
    <Field
      as="select"
  ...
  {/* Experience Years */}
  <div className="flex flex-col">
    <label className="font-medium mb-1 text-foreground">{t("profile.doctor.Experience")}</label>
    <Field
      type="number"
  ...
  {/* University */}
  <div className="flex flex-col">
    <label className="font-medium mb-1 text-foreground">{t("profile.doctor.University")}</label>
    <Field
      name="UniversityName"
  ...
  {/* Graduation Year */}
  <div className="flex flex-col">
    <label className="font-medium mb-1 text-foreground">{t("profile.doctor.Graduation")}</label>
    <Field
      type="number"
      name="GraduationYear"
      placeholder="2020"
  ...
  {/* BirthDay */}
  <div className="flex flex-col">
    <label className="font-medium mb-1 text-foreground">{t("profile.doctor.Birthday")}</label>
    <Field
      type="date"
      name="BirthDay"
      className="w-full p-3 border border-border rounded-lg bg-transparent focus:outline-none focus:ring-2 focus:ring-primary"
  ...
  {/* Phone */}
  <div className="flex flex-col">
    <label className="font-medium mb-1 text-foreground">{t("profile.doctor.Phone")}</label>
    <Field
      name="Phone"
  ...
  <div className="flex flex-col lg:col-span-2">
    <label className="font-medium mb-1 text-foreground">{t("profile.doctor.Description")}</label>
    <Field
      as="textarea"
      name="Description"
      rows={3}
  ...
  {/* CV Upload */}
  <div className="flex flex-col lg:col-span-2">
    <label className="font-medium mb-1 text-foreground">{t("profile.doctor.uploadcv")}</label>
    <input
      type="file"
      name="CV"
      accept=".pdf,.doc,.docx"
