...
import useGetTechCharts from "../../hooks/technican/useGetTechCharts";

export default function TechnicianCharts() {
  const { t } = useTranslation();
  const techId = sessionStorage.getItem("user_id")!;
  const { data, isLoading } = useGetTechCharts(techId);
    ...
    <div className="space-y-6">
      ...
      >
        <div className="flex justify-between items-center flex-wrap gap-3">
          <h2 className="text-xl font-bold">{t("tech.revenueChart")}</h2>
