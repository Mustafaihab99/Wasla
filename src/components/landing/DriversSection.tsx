...
export default function DriversSection() {
  ...
  const features = [
    {
      title: t("landing.verfiy"),
      desc: t("landing.verfiyDesc"),
      icon: <FaCar />,
    },
    {
      title: t("landing.carbook"),
      desc: t("landing.carbookDesc"),
      icon: <FaClock />,
    },
    {
      title: t("landing.emer"),
      desc: t("landing.emerDesc"),
      icon: <FaMapMarkerAlt />,
    },
  ];
