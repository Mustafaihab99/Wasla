...
import useCreateTechBook from "../../hooks/technican/useCreateTechBook";
import ReviewSection from "../../components/resident/ReviewSection";
import BookTechModal from "../../components/technician/Modal/BookTechModal";
...
export default function TechnicianViewDetails() {
  ...
  const { mutate: createBooking, isPending } = useCreateTechBook();
          ...
          <div className="flex-1 text-center md:text-left space-y-3">
            ...
            <div className="flex flex-wrap gap-3 justify-center md:justify-start mt-3">
              ...
              <button
                ...
                className="flex items-center gap-2 px-5 py-2 border border-primary text-primary rounded-xl hover:bg-primary hover:text-white transition">
                {t("tech.bookNow")}
              </button>
            </div>
